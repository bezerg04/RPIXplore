...
export default function Welcome() {
  return (
    <div id="about" className="bg-gray-200				 flex flex-col items-center justify-center p-0 text-center">
      <h3 className="text-xl font-normal mt-2 mb-4">Welcome to RPIXplore!</h3>
